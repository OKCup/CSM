...
from .ScalingAttention import Scaling_Attention
class BDC(nn.Module):
    def __init__(self, is_vec=True, input_dim=640, dimension_reduction=None, activate='relu'):
        ...
        self.SCAtten = Scaling_Attention(dim=dimension_reduction, planes=[dimension_reduction, 64, 64, 64, dimension_reduction])
