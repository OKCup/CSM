...
MODEL_PATH=./checkpoints/cross_domain_cub/ResNet12_stl_deepbdc_pretrain-Sep-04-2024-22-44-10/last_model.tar
cd ../../
...
python test.py --dataset Cars --data_path $DATA_ROOT --model ResNet12 --method stl_deepbdc --image_size 84 --gpu ${gpuid} --n_shot 5 --model_path $MODEL_PATH --reduce_dim 256 --test_task_nums 5 --penalty_C 30 --dropout_rate 0.5