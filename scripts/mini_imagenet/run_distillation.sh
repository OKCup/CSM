...
MODEL_PATH=./checkpoints/mini_imagenet/ResNet12_stl_deepbdc_pretrain-256-scr-only/last_model.tar
cd ../../../

echo "============= distill born 1 ============="
python distillation.py --dataset mini_imagenet --data_path $DATA_ROOT --model ResNet12 --method stl_deepbdc --image_size 84 --gpu ${gpuid} --lr 5e-2 --t_lr 1e-3 --epoch 170 --milestones 100 150 --save_freq 100 --teacher_path ./checkpoints/mini_imagenet/ResNet12_stl_deepbdc_pretrain-Oct-12-2024-21-01-38/last_model.tar --trial 1 --reduce_dim 128 --dropout_rate 0.5 --val last
