...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='mini_imagenet', choices=['mini_imagenet','tiered_imagenet','cub','cross_domain_cub', 'cross_domain_cars'])
    parser.add_argument('--data_path', default='/home/okc/data/miniImageNet', type=str, help='dataset path')
    ...
    elif params.dataset == 'cross_domain_cub' or 'cross_domain_cars':
        base_file = 'train'
