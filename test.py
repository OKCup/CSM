...
parser.add_argument('--data_path', default='/home/okc/data/miniImageNet', type=str)
...
parser.add_argument('--model_path', default='./checkpoints/mini_imagenet/ResNet12_stl_deepbdc_distill_born3/last_model.tar', help='meta-trained or pre-trained model .tar file path')
