...
if __name__ == '__main__':
    ...
    parser.add_argument('--pre_dataset', default='mini_imagenet', choices=['mini_imagenet','tiered_imagenet','cub'])
    parser.add_argument('--pre_data_path', default='/home/okc/data/miniImageNet', type=str, help='pretrain dataset path')
    parser.add_argument('--val_dataset', default='cub', choices=['mini_imagenet', 'tiered_imagenet', 'cub'])
    parser.add_argument('--val_data_path', default='/home/okc/data/CUB/', type=str, help='val dataset path')
    ...
    params.checkpoint_dir += '-' + datetime.now().strftime("%b-%d-%Y-%H-%M-%S")

    if not os.path.isdir(params.checkpoint_dir):
        os.makedirs(params.checkpoint_dir)
    log_path = params.checkpoint_dir + '/log.txt'
